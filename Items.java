  ...
  public static void itemsType(String item){
    ...
    switch(item){
      ...
      case "Lesser potion":
        ...
        System.out.println("You use a lesser potion ! It restored 25 health.");
        Main.sc.nextLine();
        break;
      ...
      case "Medium potion":
        ...
        System.out.println("You use a medium potion ! It restored 50 health.");
        Main.sc.nextLine();
        break;
      ...
      case "Higher potion":
        ...
        System.out.println("You use a higher potion ! It restored 100 health.");
        Main.sc.nextLine();
        break;
      ...
      case "Mana crystal":
        ...
        System.out.println("You use a mana crystal ! It restored 50 Mana!");
        Main.sc.nextLine();
        break;
