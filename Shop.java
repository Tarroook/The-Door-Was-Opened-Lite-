class Shop{
  ...
  public static void selectStuff2Sell(String[] typeSold){
    ...
    Main.clearConsole();
    UserView.showTextFile("shop/shopkeeper.txt");
    System.out.println("Gold : " + Player.playerMoney);
  ...
  public static void buyItem(String item){
    ...
    System.out.println("This " + item + " costs " + price + " gold, would you like to buy it ?");
    if(Main.YNChoice()){
  ...
  public static void randomLine(String frame, String dialogue){
    ...
    System.out.println();
    System.out.println(UserView.dialogueDisplay(true, 0, dialogue));
    Main.sc.nextLine();
  }
