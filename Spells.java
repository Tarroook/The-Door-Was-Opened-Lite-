class Spells{
    ...
    switch (spell){
      ...
      case "Charm":
        ...
        if(checkMana(manaCost)){
          ...
          System.out.println("You use your charm! The enemy's attack is halved !");
          Main.sc.nextLine();
          charmTurn = 6;
  ...
  public static void enemySpell(String spell){
    ...
    switch (spell){
      ...
      case "Ducking End":
        ...
        System.out.println("Run away!  " + Combat.currentEnemy + " has used Ducking end!");
        duckTurn = 11;
        break;
  ...
  public static void spellTurns(){
    ...
    if (charmTurn != 0){
        ...
        if (charmTurn == 0){
          Main.clearConsole();
          System.out.println("The enemy is no longer charmed!");
          Combat.enemyPhysPow *= 2;
          Combat.enemyMagPow *= 2;
          Main.sc.nextLine();
        }
    ...
    if (duckTurn != 0 && Combat.playerattacked){
      ...
      duckTurn--;
      if (duckTurn > 0){
        System.out.println("Quack. (You shall perish in " + duckTurn + " turns. Prepare.)");
        Main.sc.nextLine();
      }
      else{
        UserView.showTextFile("combatSprites/spells/quackingend/farewell.txt");
        System.out.println("Quack. (Your time is up, now repent.)");
        Main.sc.nextLine();
